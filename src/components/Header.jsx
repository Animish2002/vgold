...
export default function Header() {
  return (
    <Navbar   className="bg-[#29277a]">
      ...
      <Navbar.Collapse>
        <Navbar.Link className="text-lg md:text-white hover:text-yellow-300 " href="#" active>
          Home
        </Navbar.Link>
        <Navbar.Link href="#" className="text-lg md:text-white hover:text-yellow-300" active>
          About
        </Navbar.Link>
        <Navbar.Link href="#" className="text-lg md:text-white hover:text-yellow-300" active>
          Services
