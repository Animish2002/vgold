...
const HeroSection = () => {
  return (
    <section className="bg-white dark:bg-gray-900 h-[70vh]">
      <div className="grid w-full py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 px-20 bg-image h-[74vh]">
